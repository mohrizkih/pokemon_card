        ...
        children: [
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  T.poppinsBold('Connection Problem Occured', size: 18, color: Colors.black).bottomPadded(16),
                  T.poppinsRegular('Please check your internet connection', color: Colors.grey),
                ],
              ),
            ),
          ),
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(child: T.poppinsSemiBold('Retry', color: Colors.white)),
            ),
          ),
        ],
      ),
